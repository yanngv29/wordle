...
Un clone moderne et élégant du jeu Wordle, entièrement localisé en français.

Ce projet a été développé en collaboration avec **Antigravity**, l'assistant de codage IA de Google DeepMind.
...
### Caractéristiques
*   **Dictionnaire Riche** : Plus de 4400 mots français de 5 lettres.
*   **Design Premium** : Mode sombre natif avec animations fluides.
*   **Clavier AZERTY** : Support du clavier physique et virtuel adapté au public francophone.
...
### About the Project
"Le Mot" is a modern take on the famous puzzle game Wordle. Built using **Bun**, **React 19**, and **Tailwind CSS 4**, it provides a smooth, fast, and premium visual experience.
...
*Note: While the interface and explanations are available in English, the game itself is played exclusively with French words.*

### Features
*   **Extensive Dictionary**: Over 4,400 French 5-letter words.
*   **Premium Design**: Native dark mode with smooth animations.
*   **AZERTY Keyboard**: Full support for physical and virtual keyboards.
